...
const VALIDATION_MESSAGES = {
  ...
  PASSWORD_FORMAT: 'Password must contain at least one uppercase letter, one lowercase letter, one number, and one special character',
...
export class UserCreateDto {
  ...
  @ApiProperty({ 
    ...
    description: 'Password must be min 12 chars with upper, lower, number and special char',
    minLength: 12 
  })
...
export class UserResponseDto {
  ...
  @ApiProperty({ enum: UserRole, example: 'admin', description: 'User permission level' })
  role!: UserRole;
